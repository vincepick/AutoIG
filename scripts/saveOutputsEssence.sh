...
# Setting output path
output_path="$AUTOIG/experiments/command-outputs/tiny-mzn/$withDate"
...
# python $AUTOIG/scripts/setup.py \
#     --generatorModel $AUTOIG/data/models/tiny/tiny_gen.essence \
#     --problemModel $AUTOIG/data/models/tiny/tiny.mzn \
#     --instanceSetting graded \
#     --minSolverTime 0 \
#     --maxSolverTime 5 \
#     --solver chuffed \
